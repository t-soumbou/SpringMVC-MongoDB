...
public class BookOrderItemRecord implements Serializable
{
    ...
    //----------------------------------------------------------------------
    /**
     * Set the "bookOrderId" field value
     * This field is mapped on the database column "BOOK_ORDER_ID" ( type "INTEGER", NotNull : true ) 
     * @param bookOrderId
     */
    ...
    /**
     * Get the "bookOrderId" field value
     * This field is mapped on the database column "BOOK_ORDER_ID" ( type "INTEGER", NotNull : true ) 
     ...
     * This field is mapped on the database column "QUANTITY" ( type "INTEGER", NotNull : true ) 
     * @param quantity
     */
     ...
     * This field is mapped on the database column "PRICE" ( type "DECIMAL", NotNull : true ) 
     * @param price
     */
