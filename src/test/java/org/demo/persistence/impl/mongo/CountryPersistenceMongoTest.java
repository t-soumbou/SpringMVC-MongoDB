 ...
 *
 */
public class CountryPersistenceMongoTest extends CountryPersistenceGenericTest {
	private static final Logger LOGGER = Logger.getLogger(CountryPersistenceMongoTest.class.getName());
	...
	public void testPersistenceService() throws Exception {
    	CountryPersistence persistenceService = new CountryPersistenceImplMongo();
