 ...
 *
 */
public class CarPersistenceMongoTest extends CarPersistenceGenericTest {
	private static final Logger LOGGER = Logger.getLogger(CarPersistenceMongoTest.class.getName());
	...
	public void testPersistenceService() throws Exception {
    	CarPersistence persistenceService = new CarPersistenceImplMongo();
