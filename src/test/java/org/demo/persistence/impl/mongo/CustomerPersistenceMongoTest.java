 ...
 *
 */
public class CustomerPersistenceMongoTest extends CustomerPersistenceGenericTest {
	private static final Logger LOGGER = Logger.getLogger(CustomerPersistenceMongoTest.class.getName());
	...
	public void testPersistenceService() throws Exception {
    	CustomerPersistence persistenceService = new CustomerPersistenceImplMongo();
